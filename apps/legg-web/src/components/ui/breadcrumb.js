...
const BreadcrumbList = React.forwardRef(({ className, ...props }, ref) => (_jsx("ol", { ref: ref, className: cn("flex flex-wrap items-center gap-1.5 break-words text-sm text-neutral-500 sm:gap-2.5", className), ...props })));
...
const BreadcrumbLink = React.forwardRef(({ asChild, className, ...props }, ref) => {
    ...
    return (_jsx(Comp, { ref: ref, className: cn("text-neutral-500 transition-colors hover:text-neutral-300", className), ...props }));
});
...
const BreadcrumbSeparator = ({ children, className, ...props }) => (_jsx("li", { role: "presentation", "aria-hidden": "true", className: cn("text-neutral-500 [&>svg]:w-3.5 [&>svg]:h-3.5", className), ...props, children: children ?? _jsx(ChevronRight, {}) }));
